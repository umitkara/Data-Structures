...
- **Linked List**
    ...
    <figure>
    <img src="latex/Singly-linked-list.svg" alt="Linked List" style="width:100%;background-color: #ffffff;">
...
- **Doubly Linked List**
    ...
    <figure>
    <img src="latex/Doubly-linked-list.svg" alt="Doubly Linked List" style="width:100%;background-color: #ffffff;">
    <figcaption align="center">
...
- **Skip List**
    ...
    <figure>
    <img src="latex/Skip_list.svg" alt="Skip List" style="width:100%;background-color: #ffffff;">
    <figcaption align="center">
